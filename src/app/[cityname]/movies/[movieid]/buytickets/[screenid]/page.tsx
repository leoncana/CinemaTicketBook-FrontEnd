...
const SelectSeatPage  = () => {
    ...
    const generateSeatLayout = () => {
        ...
        let notavailableseats = (x !== -1 && screen.movieSchedulesforDate[x]) ? screen.movieSchedulesforDate[x].notAvailableSeats : [];
        ...
        <div className='selectseatpage'>
...

            {
                ...
                <div className="selectseat">
                    {screen?.movieSchedulesforDate?.length > 0 && (
                    <div className='timecont'>
                        {
                            screen.movieSchedulesforDate.map((time: any, index: number) => (
                                <h3 className={selectedTime && selectedTime._id === time._id ? 'time selected' : 'time'} 
                                onClick={() => {
                    ...
                    <div className='totalcont'>
                        <div className='total'>
                            <h2>Total</h2>
                            <h3>€ {selectedSeats.reduce((acc, seat) => acc + seat.price, 0)}</h3>
                        </div>
