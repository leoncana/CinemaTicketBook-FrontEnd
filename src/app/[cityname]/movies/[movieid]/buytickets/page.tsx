      ...
      {movie && (
        <div className="buytickets">
          ...
          {theatres?.length > 0 ? (
                    ...
                    <div>
                      ...
                      {screen.showtimes &&
                        screen.showtimes.map(
                          (showtime: any, showIndex: any) => (
                            <div key={showIndex}>
                              {formatShowtime(showtime)}{" "}
                              {/* Call formatShowtime to display formatted time */}
                            </div>
                          )
                        )}
                    </div>
            ...
            // Render a message when no theatres are available
            <div className="no-screens-message">
              <h2>No screenings are available for this date.</h2>
            </div>
          )}
        </div>
      )}
